/*
    ...
    File: header.c
    NTS-3 kaoss pad kit — REARRANGE generic effect unit header
...
const __unit_header genericfx_unit_header_t unit_header = {
  .common = {
    ...
    .params = {
      ...
      // ACTIV: number of active delay taps, quantised to nearest 10%
      // Depth knob, default 50%
