/*
    ...
    File: header.c
    NTS-3 kaoss pad kit — UNDERPASS generic effect unit header
...
const __unit_header genericfx_unit_header_t unit_header = {
  .common = {
    ...
    .unit_id     = 0x00000004U,   // unique: collage=2, rearrange=3, underpass=4
    .version     = 0x00010000U,
    .name        = "UNDERPASS",
    .num_params  = 2,
    ...
    .params = {
      ...
      // A: LFO on loop length
      // B: sub-octave drone with LPF sweep
      // C: resonant bandpass filter sweep
      // D: envelope-triggered length modulation
      {0, 4, 0, 1, k_unit_param_type_none, 0, 0, 0, {"PRESET"}},

      // ACTIV: depth of modifier (LFO depth / filter sweep range)
